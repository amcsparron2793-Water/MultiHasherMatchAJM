...
def get_long_description():
    ...
    if readme_path.is_file():
        ...
        long_description = 'hashes and compares files/folders/archives with the option to write to file'
...
setup(
    ...
    keywords=[],
    install_requires=['EasyLoggerAJM', 'tqdm', 'CounterAJM'],
    license='MIT License',
    author='Amcsparron',
    author_email='amcsparron@albanyny.gov',
    description='hashes and compares files/folders/archives with the option to write to file',
